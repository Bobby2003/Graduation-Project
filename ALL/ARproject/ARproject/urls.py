...
urlpatterns = [
    ...
    path('api/settings/save/', views.settings_save_api, name='settings_save_api'),
    path('api/settings/change-password/', views.settings_change_password_api, name='settings_change_password_api'),
    path('api/settings/export/', views.settings_export_api, name='settings_export_api'),
    path('api/settings/delete-account/', views.settings_delete_account_api, name='settings_delete_account_api'),
    ...
    path('api/center/pose-latest/', views.center_pose_latest_api, name='center_pose_latest_api'),
    path('api/center/material/targets/', views.center_material_targets_api, name='center_material_targets_api'),
    path('api/center/material/library/', views.center_material_library_api, name='center_material_library_api'),
    path('api/center/material/status/', views.center_material_status_api, name='center_material_status_api'),
    path('api/center/material/scene-latest/', views.center_material_scene_latest_api, name='center_material_scene_latest_api'),
    path('api/center/material/change/', views.center_material_change_api, name='center_material_change_api'),
    path('api/center/material/scene.glb', views.center_material_scene_glb, name='center_material_scene_glb'),
    path(
        'api/center/material/segment/<path:segment_key>/',
        views.center_material_segment_download,
        name='center_material_segment_download',
    ),
